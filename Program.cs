...
namespace log4netAdvanced
{
    class Program
    {
        ...
        {
            // create 2 persons
            var person1 = new Person("Astha", "Sinha");
            var person2 = new Person("Shubhangi", "Srivastava");
            var person3 = new Person("Divyanshu", "Kumar");
            // create 2 cars
            var car1 = new Car("Tesla Model S", 2020, person1);
            var car2 = new Car("Tesla Model X", 2020, person2);
            var car3= new Car("Tesla Model S", 2020, person3);
            // logging
